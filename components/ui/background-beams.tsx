...
import { type EffectsMode } from "@/hooks/use-effects-mode";

export const BackgroundBeams = React.memo(
  ({ className, mode = "full" }: { className?: string; mode?: EffectsMode }) => {
    const allPaths = [
    ...
    // Filtro de paths apenas no modo lite
    const paths = isLite ? allPaths.filter((_, i) => i % 2 === 0) : allPaths;
      ...
      >
        ...
        >
          ...
          <path
            ...
            stroke="var(--beam-glow-1)"
            strokeOpacity={isLite ? "0.02" : "0.05"}
            strokeWidth="0.5"
          ></path>
          ...
          <defs>
            {paths.map((_, index) => (
              <motion.linearGradient
                ...
                transition={!isStatic ? {
                  duration: isLite ? 70 : Math.random() * 10 + 10,
                  ease: "easeInOut",
                  repeat: Infinity,
              ...
              >
                ...
                <stop offset="32.5%" stopColor="var(--beam-2)"></stop>
                <stop offset="100%" stopColor="var(--beam-3)" stopOpacity="0"></stop>
              </motion.linearGradient>
            ))}
          </defs>
        </svg>
