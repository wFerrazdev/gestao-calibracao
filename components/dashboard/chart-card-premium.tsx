...
export function ChartCardPremium({
    ...
    return (
        <div className={cn(
            "relative rounded-2xl bg-white dark:bg-[#1e2330] border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-2xl h-full flex flex-col transition-colors duration-300 overflow-visible",
            className
        )}>
            {/* Background Decoration Container - Keeps glow effects inside rounds */}
            ...
            <div className="relative p-6 flex flex-col h-full z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                    <div>
                        <h2 className="text-lg sm:text-lg font-semibold text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
